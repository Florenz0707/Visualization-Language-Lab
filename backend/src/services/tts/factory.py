"""TTS factory for creating provider instances."""
...
from .config_loader import TTSConfigLoader
...
class TTSFactory:
    ...
    def __init__(self, config_path: str = "config/tts.yaml"):
        ...
        """
        self.config_loader = TTSConfigLoader(config_path)
    ...
    def get_provider(self, model_name: str = None) -> Optional[BaseTTSProvider]:
        ...
        # Get provider class
        provider_type = model_config.get("provider", model_name)
        ...
        try:
            ...
            logger.info(f"Created TTS provider: {model_name}")
            return provider
